...
<div class="project-page" bind:this={pageContainer}>
	<div class="container">
		...
		<section bind:this={mechanicalSection} class="hello-world" in:maskSlideIn={{ duration: 1200, delay: 330, reverse: true }}>
			...
			<div class="text-box">
				<p>
					The mechanical system deisgn began with the development of a minature Proton Irradiation Sample Holder (µPISH). 
					This design functionally replicates the previous PISH II with a fraction of the footprint, allowing up to four samples to be mounted to each frame for a total of eight.
					The most important performance aspect is the ability to indivudually heat samples to temperatures exceeding 500°C while adjacent samples stay below 100°C to prevent annealing.
		...
		<section class="hello-world" in:maskSlideIn={{ duration: 1200, delay: 460, reverse: true }}>
			...
			<div class="text-box">
				<p>
					...
					The ends of the cooling line have milled grooves to attached to wall mounted liner actuators, and a spout to attach a water or air line to.
		...
		<section class="hello-world" in:maskSlideIn={{ duration: 1200, delay: 580, reverse: true }}>
			...
			<div class="text-box">
				<p>
					...
					It was proven that the µPISH were successfully overengineered to mitigate transverse heating, with adjacent sample temperatures remaining below 35°C with primary temepratures up to 500°C.
				</p>
			</div>
		</section>
		...
		<section bind:this={electricalSection} class="hello-world" in:maskSlideIn={{ duration: 1200, delay: 640, reverse: true }}>
			...
			<div class="text-box">
				<p>
					...
					It is essential that the current pickup off the sample is not noised by the ceramic resistance heater or lost via a current dividor as a result of a poor ceramic resistance profile.
					The circuit shown below is set up to individually measure the ceramic resistance alongside leakage current with and without a 5uA source mimicking the beam currrent. 
					...
					Leakage current was measured with across a 100KΩ resistor to match the arduino pikcup in the control room, mapping 0-30uA to 0-5v.
				</p>
			</div>
		</section>
		...
		<section class="hello-world" in:maskSlideIn={{ duration: 1200, delay: 700, reverse: true }}>
			...
			<div class="text-box">
				<p>
					...
					Due do the current dividor this generated, the graph below shows the corrected values for currents measured.
		...
		<section bind:this={futureSection} class="hello-world" in:maskSlideIn={{ duration: 1200, delay: 880, reverse: true }}>
			...
			<div class="text-box">
				<p>
					...
					The control system must be accompanied by various failsafes that trigger beam shut down to relaibly run without continous operator supervision.
				</p>
			</div>
		</section>
